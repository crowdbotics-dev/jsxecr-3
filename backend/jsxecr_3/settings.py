"""
Django settings for jsxecr_3 project.
...
WSGI_APPLICATION = 'jsxecr_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jsxecr_3 API",
    "DESCRIPTION": "API documentation for jsxecr_3 App",
    "VERSION": "v1",
}
